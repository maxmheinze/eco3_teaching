...
[We call it a [**backdoor path**]{.col2} because it enters $X$ trough the “back door,” via an arrow pointed *at* $X$.]{.fragment}
...
$$
\boldsymbol{y} \sim \boldsymbol{x} + \boldsymbol{u} + \boldsymbol{y}.
$$
:::
:::
::::
...
A **collider** is a variable that is influenced by two variables, for example (but not necessarily), the dependent and the explanatory variables. 
:::
:::
::::
...
:::{.incremental}
- All of the previous three examples are taken from “The Book of Why” by @pearl2018. You can read more about them, and about similar examples, in the book.
